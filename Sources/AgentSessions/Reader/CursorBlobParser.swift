...
public enum CursorBlobParser {
    private static let decoder = JSONDecoder()

    public static func extractMessage(from data: Data) -> UnifiedMessage? {
    ...
    public static func findEmbeddedJSONString(in text: String) -> String? {
