...
public struct CursorTranscriptStore: Sendable {
    ...
    public init(fileSystem: any FileSystemProtocol, projectsDir: URL) {
    ...
    public func listSummaries() async throws -> [SessionSummary] {
    ...
    public func loadSession(id: String, projectPath: String? = nil, limit: Int?) throws -> UnifiedConversation? {
    ...
    public func projectPath(forSessionId sessionId: String) -> String? {
    ...
    public func resolvedProjectPath(forTranscriptFile file: URL) -> String? {
    ...
    private func summary(forTranscriptFile file: URL) throws -> SessionSummary {
        ...
        return try SessionSummary(
            ...
            lastMessageAt: FileSystemHelper.fileModificationDate(file, fileSystem: fileSystem),
            model: nil,
            messageCount: 0,
