...
public protocol SQLiteReader: Sendable {
...
/// Describes SQLite query failures in reader implementations.
...
public struct DefaultSQLiteReader: SQLiteReader, Sendable {
    public init() {}

    public func query(dbPath: String, sql: String) throws -> [[String: Any]] {
    ...
    public func queryBlobs(dbPath: String) throws -> [(id: String, data: Data)] {
    ...
    public func queryRecentBlobs(dbPath: String, limit: Int) throws -> [(id: String, data: Data)] {
