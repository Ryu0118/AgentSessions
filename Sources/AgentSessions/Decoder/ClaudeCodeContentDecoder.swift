...
public enum MessageFilter: Sendable {
    public static func isNoise(_ content: String) -> Bool {
    ...
    public static func lastMeaningful(_ candidates: [String]) -> String? {
...
public enum ClaudeCodeContentDecoder: Sendable {
